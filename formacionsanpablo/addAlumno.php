...
<body>
    ...
    <form name="addalumno" id="addalumno" class="formularioCorporativo" >
        <div class="row">
            <div class="m-2 col-3">
        ...
        <div class="row">
            <div class="m-2 col-4">
                ...
                <input type="text" name="localidad" id="localidad" require class="form-control">
            </div>
            <div class="m-2 col-4">
    ...
    <button id="listaAlumno" class="btn btn-dark text-white w-25">Lista de Alumnos</button>
    </div>
