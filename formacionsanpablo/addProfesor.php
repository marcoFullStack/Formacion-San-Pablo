...
<body>
    ...
    <form name="addprofesor" id="addprofesor" class="formularioCorporativo" >
        <div class="row">
            <div class="m-2 col-3">
            ...
            <div class="m-2 col-3">
                <label class="form-label">Nº de Profesor</label>
        ...
        <div class="row">
            <div class="m-2 col-4">
                ...
                <input type="text" name="aula" id="aula" require class="form-control">
            </div>
            <div class="m-2 col-4">
                <label class="form-label">Curso</label>
                <input type="text" name="curso" id="curso" require class="form-control">
            </div>
        </div> 
    ...
    <button id="listaProfesores" class="btn btn-dark text-white w-25">Lista de Profesores</button>
    </div>
    ...
    <script src="js/scriptAddProfesor.js"></script>
</body>
</html>