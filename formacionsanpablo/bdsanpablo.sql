...
-- Tiempo de generación: 26-07-2024 a las 06:34:53
...
('v', 'silverhand', '45632145', 'verosp.msm@hotmail.com', '65897456', 'night city', 'netrunner');
...
--
-- Volcado de datos para la tabla `marco_contacto`
--

INSERT INTO `marco_contacto` (`id`, `nombre`, `apellidos`, `tlf`, `mail`, `mensaje`) VALUES
(2, '', 'deadpool', '65458974', '', 'chimichanga');
...
CREATE TABLE `marco_cursosdesempleados` (
  ...
  `temario` text COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Volcado de datos para la tabla `marco_cursosdesempleados`
--

INSERT INTO `marco_cursosdesempleados` (`codcertificado`, `certificado`, `nivel`, `horas`, `practicas`, `disponible`, `activo`, `ver`, `temario`) VALUES
('asfasdf', 'asdfsad', '2', '123', '2', 'aacasd', 'asdf', 'asdf', 'asdf');
...
--
-- Volcado de datos para la tabla `marco_cursostrabajadores`
--

INSERT INTO `marco_cursostrabajadores` (`curso`, `horas`, `disponible`, `activo`, `ver`) VALUES
('ADGD039PO CONTABILIDAD FINANCIERA', '100', 'Toda España', 'Si', 'https://ietformacion.com/convocatoria-de-cursos-estatal-2023/estatal-2023-adgd039po-contabilidad-financiera/');
