...
<nav aria-label="breadcrumb" class="container-lg">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Cursos para Trabajadores</li>
  </ol>
</nav>
    <div class="negro">
            ...
            <table class="table" id="listatabla">
                <thead>
                    <tr class="text-center">
                        ...
                        <th class="bg-body-secondary">Eliminar</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                        require_once("conectar.php");
                        $data = $cnx->query("SELECT curso,horas,disponible,activo,ver FROM marco_cursostrabajadores ORDER BY curso");
                        while ($row = $data->fetch_assoc()) {
                            extract($row);
                            echo "<tr class='text-center align-middle'><td>$curso</td><td>$horas</td><td>$disponible</td><td>$activo</td><td><a href='$ver' class='text-decoration-none text-white'><button type='button' class='btn btn-dark text-white'>más detalles</button></a></td><td><button type='button' class='btn btn-danger btnEliminar'>Eliminar</button></td></tr>";
                        }
                    ?>
                </tbody>
            </table>
    ...
    <script src="js/listaCursoTrabajadores.js"></script>
</body>
</html>