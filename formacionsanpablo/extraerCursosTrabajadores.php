...
<head>
    ...
    <link href="css/stylesextraerCursosDesempleados.css" rel="stylesheet">
</head>
<body>
    <?php
                ...
                <tbody>
                    <?php
                        ...
                        while ($row = $data->fetch_assoc()) {
                            extract($row);
                            echo "<tr class='text-center align-middle'><td>$curso</td><td>$horas</td><td>$disponible</td><td>$activo</td><td><a href='$ver' class='text-decoration-none text-white'><button type='button' class='btn btn-dark text-white'>más detalles</button></a></td></tr>";
                        }
                    ?>
                </tbody>
            </table>
